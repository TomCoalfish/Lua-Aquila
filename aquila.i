...
namespace Aquila 
{
    ...
    public:
        ...
        %extend {
            SampleType __getitem(size_t i) { SampleType* m_data = $self->toArray(); return m_data[i]; }
            void __setitem(size_t i, SampleType val) { SampleType * m_data = $self->toArray(); m_data[i] = val; }
        }
    ...
    public:
        ...
        %extend {
            SampleType __getitem(size_t i) { SampleType * m_data = toArray(); return m_data[i]; }
    ...
    public:
        ...
        %extend {
            Frame __getitem(size_t i) { return m_frames[i]; }
